...
?>
      ...
      <tr>   <td>Quantity:<input type="number" Name="quantity" value="1" min=1 max=1000 class="number"></td>

      <tr>  <td><input type="submit" value="Add to Cart" class="btn btn-success btn-sm"></td>
            </form>
            <?php
    }
    else
